...
import styles from "@/app/salud/Salud.module.css";

export interface SaludInitialData {
    healthServices: any[];
    pharmacies: any[];
    pharmaciesDate: string;
}

interface MobileSaludProps {
    initialData?: SaludInitialData;
}

export default function MobileSalud({ initialData }: MobileSaludProps) {
    const healthServices = initialData?.healthServices ?? [];
    const pharmacies = initialData?.pharmacies ?? [];
    const pharmaciesDate = initialData?.pharmaciesDate ?? "";
