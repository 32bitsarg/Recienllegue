...
import styles from "@/app/unnoba/UNNOBA.module.css";
...
export interface UNNOBAInitialData {
    sedes: any[];
    services: any[];
}

interface MobileUNNOBAProps {
    initialData?: UNNOBAInitialData;
}

export default function MobileUNNOBA({ initialData }: MobileUNNOBAProps) {
    const sedes = initialData?.sedes ?? [];
